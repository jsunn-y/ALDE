...
if __name__ == "__main__":
    ...
    budget = 480 - n_pseudorand_init #budget does not include MLDE evaluation at the end with 96 samples, and does not include random samples at the beginning
        ...
        for mtype in ['DKL_BOTORCH']: #['GP_BOTORCH', 'DKL_BOTORCH', 'CDKL_BOTORCH'] #['GP', 'DKL', 'CDKL']
            for acq_fn in ['UCB']: #'QEI', 'UCB','TS'
                ...
                if 'MLDE' in mtype:
                    ...
                    fname = mtype + '-oneround-DO-' + str(dropout) + '-' + kernel + '-' + acq_fn + '-' + str(arc[-2:]) + '_' + str(r + 1)
